...
function print_many_words() //(index_pmw)
{
  ...
  document.convarea.converted_text.value = ans; //text area where convered value has to be shown.
 ...
 // document.convarea.html_text.value = html_txt;
  // commented to avoid displaying unicode charector on screen.
}
var html_txt; //varialbe to hold value in unicode charactors

function convert2unicode(str)
{
  var text_pmw = many_words(str);
